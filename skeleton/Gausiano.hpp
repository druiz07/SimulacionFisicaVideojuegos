...
public:
	GeneradorGaussiano(Vector3 devpos, Vector3 devvel, std::string n);
...
GeneradorGaussiano::GeneradorGaussiano(Vector3 dp, Vector3 dv,std::string n):GeneradorSimple(n)
{
	devpos = dp;
	devvel = dv;
