...
void VientoGenerator::updateForce(Particula* p, double t)
{
	...
	Vector3 v = p->getVelocity()-windVel; //v seria -> getV- velViento , hacer que herede de la clase y un metodo para settear la velocidad , crear un genersdor con vientos 
